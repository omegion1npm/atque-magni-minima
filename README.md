...
- [@omegion1npm/atque-magni-minima](#@omegion1npm/atque-magni-minima)
...
```js
import copy from '@omegion1npm/atque-magni-minima';
...
```js
import { copyStrict } from '@omegion1npm/atque-magni-minima';
...
```js
import { createCopier } from '@omegion1npm/atque-magni-minima';
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@omegion1npm/atque-magni-minima**      | **5,880,312**       |
| lodash.cloneDeep   | 2,706,261           |
| clone              | 2,207,231           |
| deepclone          | 1,274,810           |
| fast-clone         | 1,239,952           |
| ramda              | 1,146,152           |
| @omegion1npm/atque-magni-minima (strict) | 852,382             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@omegion1npm/atque-magni-minima**      | **162,858**         |
| ramda              | 142,104             |
| deepclone          | 133,607             |
| fast-clone         | 101,143             |
| clone              | 70,872              |
| @omegion1npm/atque-magni-minima (strict) | 62,961              |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@omegion1npm/atque-magni-minima**      | **303**             |
| fast-clone         | 245                 |
| deepclone          | 151                 |
| lodash.cloneDeep   | 150                 |
| clone              | 93                  |
| @omegion1npm/atque-magni-minima (strict) | 90                  |
| ramda              | 42                  |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@omegion1npm/atque-magni-minima**      | **2,420,466**       |
| deepclone          | 1,386,896           |
| ramda              | 1,024,108           |
| lodash.cloneDeep   | 989,796             |
| clone              | 987,721             |
| @omegion1npm/atque-magni-minima (strict) | 617,602             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@omegion1npm/atque-magni-minima**      | **152,792**         |
| clone              | 74,347              |
| fast-clone         | 66,576              |
| lodash.cloneDeep   | 64,760              |
| ramda              | 53,542              |
| deepclone          | 28,823              |
| @omegion1npm/atque-magni-minima (strict) | 21,362              |
